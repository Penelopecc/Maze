...
while (depok==0):
    ...
    B = saisieNombre2("Y : ")
    if (A == l-1):
        if (Matrice[B+1][A] != -1) | (Matrice[B-1][A] != -1) | (Matrice[B][A-1] != -1):
            depok = 1
    elif (B == h-1):
        if (Matrice[B][A+1] != -1) | (Matrice[B][A-1] != -1) | (Matrice[B-1][A] != -1):
            depok = 1
    else:
...
while (arok==0):
    ...
    Y = saisieNombre2("Y : ")
    if (A == l-1):
        if (Matrice[B+1][A] != -1) | (Matrice[B-1][A] != -1):
            depok = 1
    elif (B == h-1):
        if (Matrice[B][A+1] != -1) | (Matrice[B][A-1] != -1):
            depok = 1
